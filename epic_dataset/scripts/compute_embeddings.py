"""
Precompute RoBERTa [CLS] embeddings for the EPIC dataset.

Run once before noise experiments:
    python scripts/compute_embeddings.py \
        --data_path data/epic_dataset/processed/train.json \
        --output_path data/epic_dataset/processed/train_embeddings.npy
...
def main():
    parser = argparse.ArgumentParser(description='Compute RoBERTa [CLS] embeddings for EPIC dataset')
    parser.add_argument('--data_path', type=str,
                        default='data/epic_dataset/processed/train.json',
                        help='Path to train.json (jsonlines)')
    parser.add_argument('--output_path', type=str,
                        default='data/epic_dataset/processed/train_embeddings.npy',

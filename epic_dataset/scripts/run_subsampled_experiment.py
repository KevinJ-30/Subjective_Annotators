...
def run_experiment(approach, n_annotators, experiment_id):
    ...
    try:
        ...
        # Subsample data
        train_data, selected_annotators = subsample_annotators('data/epic_dataset/processed/train.json', n_annotators)
        test_data, _ = subsample_annotators('data/epic_dataset/processed/test.json', n_annotators)

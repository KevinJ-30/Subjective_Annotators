"""
Precompute RoBERTa [CLS] embeddings for the MD-Agreement dataset.

Run once before noise experiments:
    python scripts/compute_embeddings.py \
        --data_path data/md_agreement/processed/train.json \
        --output_path data/md_agreement/processed/train_embeddings.npy

Produces two files:
    <output_path>          — float32 array (N_unique_instances, 768)
    <output_path stem>_ids.npy — object array (N_unique_instances,) of original_id values
"""
...
def main():
    parser = argparse.ArgumentParser(description='Compute RoBERTa [CLS] embeddings for MD-Agreement dataset')
    parser.add_argument('--data_path', type=str,
                        default='data/md_agreement/processed/train.json',
                        help='Path to train.json (jsonlines)')
    parser.add_argument('--output_path', type=str,
                        default='data/md_agreement/processed/train_embeddings.npy',

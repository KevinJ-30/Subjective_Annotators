...
def download_HSB():
    """
    Download HSB dataset from Hugging Face datasets
    """
    print("Downloading HSB dataset...")
    
    # Create data directories
    base_path = Path("data/hsb_brexit")
    processed_path = base_path / "processed"
    processed_path.mkdir(parents=True, exist_ok=True)

    # Load dataset with the correct configuration
    dataset = load_dataset("MichiganNLP/TID-8", "hs_brexit-ann")
